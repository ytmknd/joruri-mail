...
ActiveRecord::Schema.define(version: 20160729171630) do
  ...
  add_index "webmail_address_groupings", ["address_id"], name: "address_id", using: :btree
  add_index "webmail_address_groupings", ["group_id"], name: "group_id", using: :btree

  create_table "webmail_address_groups", force: :cascade do |t|
    t.integer  "parent_id",  limit: 4
    t.integer  "user_id",    limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "webmail_address_groups", ["user_id"], name: "user_id", using: :btree

  create_table "webmail_addresses", force: :cascade do |t|
    t.integer  "user_id",           limit: 4
    t.integer  "group_id",          limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "webmail_addresses", ["user_id", "group_id"], name: "user_id", using: :btree

  create_table "webmail_docs", force: :cascade do |t|
    t.string   "state",        limit: 15
    t.integer  "sort_no",      limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "webmail_filter_conditions", force: :cascade do |t|
    t.integer  "user_id",    limit: 4
  ...
  add_index "webmail_filter_conditions", ["user_id", "filter_id"], name: "user_id", using: :btree

  create_table "webmail_filters", force: :cascade do |t|
    t.integer  "user_id",          limit: 4
    t.string   "state",            limit: 15
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "webmail_filters", ["user_id"], name: "user_id", using: :btree

  create_table "webmail_mail_address_histories", force: :cascade do |t|
    t.integer  "user_id",          limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "address",          limit: 255
  ...
  add_index "webmail_mail_address_histories", ["user_id"], name: "user_id", using: :btree

  create_table "webmail_mail_nodes", force: :cascade do |t|
    t.integer  "user_id",                         limit: 4
  ...
  add_index "webmail_mail_nodes", ["user_id", "uid", "mailbox"], name: "user_id", length: {"user_id"=>nil, "uid"=>nil, "mailbox"=>16}, using: :btree

  create_table "webmail_mailboxes", force: :cascade do |t|
    t.integer  "user_id",    limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "sort_no",    limit: 4
  ...
  add_index "webmail_mailboxes", ["user_id", "sort_no"], name: "user_id", using: :btree

  create_table "webmail_settings", force: :cascade do |t|
    t.integer  "user_id",    limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "name",       limit: 255
  ...
  add_index "webmail_settings", ["user_id", "name"], name: "user_id", using: :btree

  create_table "webmail_signs", force: :cascade do |t|
    t.integer  "user_id",      limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "level_no",     limit: 4
  ...
  add_index "webmail_signs", ["user_id"], name: "user_id", using: :btree

  create_table "webmail_templates", force: :cascade do |t|
    t.integer  "user_id",      limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "name",         limit: 255
  ...
  add_index "webmail_templates", ["user_id"], name: "user_id", using: :btree
